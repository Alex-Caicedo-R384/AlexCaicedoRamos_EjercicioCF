...
using AlexCaicedoRamos_EjercicioCF.Data;
using AlexCaicedoRamos_EjercicioCF.Models;

namespace AlexCaicedoRamos_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly AlexCaicedoRamos_EjercicioCFContext _context;

        public BurgersController(AlexCaicedoRamos_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'AlexCaicedoRamos_EjercicioCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AlexCaicedoRamos_EjercicioCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
